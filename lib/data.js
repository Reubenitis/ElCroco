...
export const ARTIST = {
  name: "EL CROCO",
  location: "Miami | Dallas",
  roles: "Artist · Collector · Curator",
};

export const LINKS = {
  spotify: "https://open.spotify.com/album/5407V0Sg6TTgzVnFPQo7kX", // ORO PURO album
...
export const HERO_ARTIFACTS = [
  ...
  { image: "/img/hero/dice.jpg", alt: "CrocoDice — crystal dice with gold detailing and a reptilian eye" },
];
